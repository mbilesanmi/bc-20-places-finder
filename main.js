...
window.onclick = function(event) {
  ...
  if (!event.target.matches('.locateDropbtn')) {

    var dropdowns = document.getElementsByClassName("locateDrop-content");
    var i;
  ...
  // Close the dropdown menu if the user clicks outside of it
  if (!event.target.matches('.categoryDropbtn')) {

    var dropdowns = document.getElementsByClassName("categDrop-content");
    var i;
    for (i = 0; i < dropdowns.length; i++) {
      var openDropdown = dropdowns[i];
      if (openDropdown.classList.contains('show')) {
